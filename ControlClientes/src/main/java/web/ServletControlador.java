...
//        request.getRequestDispatcher("clientes.jsp").forward(request, response);
    ...
    private void modificarCliente(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //recuperamos los valores del formulario editar clientes
        int idCliente = Integer.parseInt(request.getParameter("idCliente"));
        ...
        // CREAMOS EL OBJETO DEL CLIENTE CON LOS DATOS QUE HEMOS RECIBIDO(Modelo)
        Cliente cliente = new Cliente(idCliente, nombre, apellido, email, telefono, saldo);
        //modificar el nuevo objeto en la base de datos
        int registrosActualizados = new ClienteDaoJDBC().actualizar(cliente);
    ...
    private void insertarCliente(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     private void eliminarCliente(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("registrosActualizados = " + registroEliminado);
